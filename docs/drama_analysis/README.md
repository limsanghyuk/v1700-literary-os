...
1. 정상 원본·Stage01/02 후보: `공주의남자`, `녹두꽃`
...
→ 완료 작품 제외 또는 신규 작품 확인
→ source inventory·SourceLock
→ 작품 분류: NEW / NORMAL_UPGRADE / STAGE02_REAUTHOR / SOURCE_HOLD
→ 회차별 Q1→Q4·체크포인트
→ 전 작품 Stage01~03 강검증
→ Stage04 fan-in
→ 독립 ZIP·전체 DB ZIP
