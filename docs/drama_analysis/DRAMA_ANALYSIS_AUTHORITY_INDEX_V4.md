...
5. `DRAMA_ENSEMBLE_TRACKING_AND_EDGE_SELECTIVITY_POLICY_V1.md` — Stage03·LocalEdge 선택성 세부 규칙
6. `DRAMA_CLOSE_READING_MASTER_PROTOCOL_V3.md` — 직접독해 깊이 세부 규칙
7. `DRAMA_LINEAGE_PACKAGE_HANDOFF_V2.md` — lineage·package 세부 규칙
8. `DRAMA_SESSION_EXECUTION_SAFETY_V1.md` — 복구·세션 안전 참고
9. 최신 DB status 및 세션 handoff

V1 guide와 V3 validation 문서는 역사·세부 참고로 유지한다. 실행 cadence가 충돌하면 V2 guide와 효율 정책을 따른다.
