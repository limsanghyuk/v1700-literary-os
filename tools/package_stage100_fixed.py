...
def main() -> int:
    ...
    filelist_path = package_dir / "V1700_stage100_FIXED_filelist.txt"
    integrity_path = package_dir / "stage100_FIXED_integrity_validation_report.md"
    sha_path.write_text(sha + "\n", encoding="utf-8")
    filelist_path.write_text("\n".join(names) + "\n", encoding="utf-8")
    validation = validate_zip(out)
    integrity_path.write_text(
        "# Stage100 FIXED Integrity Validation\n\n"
