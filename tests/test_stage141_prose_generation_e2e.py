...
def test_stage141_is_the_active_release_baseline() -> None:
    ...
    assert '"active_version": "stage141"' in manifest or '"active_version": "stage142"' in manifest or '"active_version": "stage143"' in manifest or '"active_version": "stage144"' in manifest or '"active_version": "stage145"' in manifest or '"active_version": "stage146"' in manifest
