...
from tools.package_stage100_fixed import package, validate_zip

ROOT = Path(__file__).resolve().parents[1]


def test_stage100_package_policy_excludes_runtime_indexes_and_cache(tmp_path):
    out = tmp_path / "stage100.zip"
