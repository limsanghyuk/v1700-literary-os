...
from v1700.gates.stage179_release_gate import run_stage179_release_gate
ROOT=Path(__file__).resolve().parents[1]
def test_stage179_evolution_contract_passes() -> None:
    result=run_stage179_evolution_contract(ROOT, mode="historical")
...
def test_stage179_release_gate_requires_gitnexus_7x12() -> None:
    result=run_stage179_release_gate(ROOT)
    assert result["status"] == "pass"
