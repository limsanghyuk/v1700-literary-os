...
def test_stage144_is_the_active_release_baseline() -> None:
    ...
    assert '"active_version": "stage144"' in manifest or '"active_version": "stage145"' in manifest or '"active_version": "stage146"' in manifest or '"active_version": "stage147"' in manifest or '"active_version": "stage148"' in manifest or '"active_version": "stage149"' in manifest
