...
from v1700.gates.stage184_release_gate import run_stage184_release_gate
ROOT=Path(__file__).resolve().parents[1]
def test_stage184_page07_release_seal_passes() -> None:
    result=run_stage184_page07_release_seal(ROOT, mode="historical")
...
def test_stage184_release_gate_requires_gitnexus_7x12() -> None:
    result=run_stage184_release_gate(ROOT)
    assert result["status"] == "pass"
