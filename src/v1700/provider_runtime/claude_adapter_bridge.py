...
class ClaudeAdapterBridge(FixtureProvider):
    """Dry-run compatibility bridge for claude runtime contracts.
    ...
    def __init__(self, provider_id: str = "claude"):
        super().__init__(provider_id=provider_id, text="claude fixture bridge response")
