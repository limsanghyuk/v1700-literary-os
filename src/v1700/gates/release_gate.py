...
def _historical_evidence_summary(root: Path, stage: str, output_key: str) -> dict:
    ...
    issues: list[str] = []
    if stage in {"stage100", "stage101", "stage102", "stage103", "stage104", "stage105", "stage106", "stage107", "stage108", "stage109", "stage110", "stage111", "stage112", "stage113", "stage114", "stage115", "stage116", "stage117", "stage118", "stage119", "stage120", "stage121", "stage122", "stage123", "stage124", "stage125", "stage126", "stage127", "stage128", "stage129", "stage130", "stage131", "stage132", "stage133", "stage134", "stage135", "stage136", "stage137"}:
        report_path = root / "release" / "current" / f"{output_key}_report.json"
